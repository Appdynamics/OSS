...
You will now be authenticated against the current Tomcat realm. Usually, for this authentication the user information is in conf/tomcat-users.xml. See the Tomcat documentation for more information on realms.
