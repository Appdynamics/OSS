...
public class SelectorHandlerRunner implements Runnable {
    ...
    private static final int ACCEPT_OP_BATCH_SIZE = Integer.parseInt(System.getProperty("com.sun.grizzly.accept.op.batch.size", "1"));
    ...
    private boolean handleSelectedKey(final SelectionKey key,
        ...
        try {
            ...
            if ((readyOps & SelectionKey.OP_ACCEPT) != 0) {
                for (int i = 0; i < ACCEPT_OP_BATCH_SIZE; i++) {
