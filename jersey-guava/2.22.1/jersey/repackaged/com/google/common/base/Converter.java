 ...
 * an example round-trip using {@link jersey.repackaged.com.google.common.primitives.Doubles#stringConverter}:
 *
 * <ol>
 ...
 *     jersey.repackaged.com.google.common.primitives.Ints#stringConverter Ints.stringConverter} or the {@linkplain
 *     #reverse reverse} views of these.
 * <li>Convert between specific preset values using {@link
 *     jersey.repackaged.com.google.common.collect.Maps#asConverter Maps.asConverter}. For example, use this to create
